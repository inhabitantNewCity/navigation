...
TContour::TContour (const TContour &obj)
{
	...
	NumPoints = obj.NumPoints;
       // minXY = obj.minXY;
	   // maxXY = obj.maxXY;
	   T_Point obj_minXY  = obj.minXY;
	   T_Point obj_maxXY  = obj.maxXY;
		minXY.SetX(obj_minXY.GetX());
		minXY.SetY(obj_minXY.GetY());
		maxXY.SetX(obj_maxXY.GetX());
		maxXY.SetY(obj_maxXY.GetY());
	   // minXY.SetX(obj.minXY.GetX());
	   // minXY.SetY(obj.minXY.GetY());
	   // maxXY.SetX(obj.maxXY.GetX());
       // maxXY.SetY(obj.maxXY.GetY());
	VectorPoints = new vector <T_Point> ();
